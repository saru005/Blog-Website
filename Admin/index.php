<?php
  ...
  {
    echo "<script>alert('Daleted successfully..')</script>";
  }
  if(isset($_GET['added']))
  {
...
<header  id="header" class="header fixed-top d-flex align-items-center">
    ...
    <div class="d-flex align-items-center justify-content-between">
      <a href="index.php" class="logo d-flex align-items-center">
        <span class="d-none d-lg-block">AdminPannel</span>
      </a>
    </div>
    <!-- End Logo -->
      ...
      <ul class="d-flex align-items-center">
        <li class="nav-item dropdown pe-3">
          ...
          <a class="nav-link nav-profile d-flex align-items-center pe-0" href="#" data-bs-toggle="dropdown">
            ...
            <span class="d-none d-md-block dropdown-toggle ps-2">S.Yadav</span>
  ...
  <aside id="sidebar" class="sidebar">
   ...
   <li class="nav-item">
        <a class="nav-link" href="index.php?information">
...
<!-- total post comments and categoris cards -->
  <?php
  ...
  <div class="col-sm-4">
    <div class="card">
      <div class="card-body">
        ...
        <h3 class="text-center"><?=getNumberOfPosts($db);?></h3>
      </div>
    </div>
  </div>
  <div class="col-sm-4">
    <div class="card">
      <div class="card-body">
        ...
        <h3 class="text-center"><?=getNumberOfComments($db);?></h3>
      </div>
    </div>
  </div>
  ...
  <div class="col-sm-4">
    <div class="card">
      <div class="card-body">
        ...
        <h3 class="text-center"><?=getNumberOfCategories($db);?></h3>
      </div>
    </div>
  </div>
 </section>
...
<?php
      ...
      {
?>
<section style="margin-left:330px;margin-top:100px;margin-right:20px" class="section profile">
  <div class="row">
    <div class="col-xl-4">
...
?>
  ...
  <nav class="navbar navbar-expand-lg navbar-light bg-light border-top">
          <div class="container m-auto">
            <a href="https://www.linkedin.com/in/sarvesh-yadav-4ab74517a" class="m-auto" style="text-decoration: none;">Developed by Sarvesh Yadav</a>
          </div>
        </nav>
  </footer><!-- End Footer -->
